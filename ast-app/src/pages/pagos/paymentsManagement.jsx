...
const PaymentsManagement = () => {
    ...
    useEffect(() => {
        const cargarPersonas = async () => {
            try {
                const response = await axios.get(`${import.meta.env.VITE_REACT_APP_API_URL}/personas/role/user`); // Endpoint para obtener personas
    ...
    const obtenerPagosPorPersona = async () => {
        axios
            .get(`${import.meta.env.VITE_REACT_APP_API_URL}/pagos/persona/${Id}`)
            .then((response) => {
        ...
        <>
            ...
            <section className="container-fluid mh-100 bg-secondary">
                            ...
                            <Card className="mb-3">
                                <Card.Body>
                                    ...
                                    <Card.Text>
                                        ...
                                        {pago.fechaPago.substring(0, 10)} <br />{" "}
                                        <span
                                            className={
                                                pago.estado == "Pagado"
                                                    ? "text-success"
                ...
                <PagoModal
                    ...
                    personaId={Id} // Pasar el Id de la persona seleccionada al modal
                />
