...
const TrainingManagement = () => {
  ...
  const fetchEntrenamientos = async () => {
    try {
      const response = await fetch(
        `${import.meta.env.VITE_REACT_APP_API_URL}/entrenamientos`
      );
      if (response.ok) {
  ...
  const fetchPersonas = async () => {
    try {
      const response = await fetch(
        `${import.meta.env.VITE_REACT_APP_API_URL}/personas`
      );
      if (response.ok) {
        const data = await response.json();
        setStudents(data);
  ...
  const fetchAsistentes = async (entrenamientoId) => {
    try {
      const response = await fetch(
        ...
        }/asistencias/entrenamiento/${entrenamientoId}`
      );
      if (response.ok) {
        const data = await response.json();
  ...
  const actualizarEntrenamiento = async (id) => {
    try {
      const response = await fetch(
        `${import.meta.env.VITE_REACT_APP_API_URL}/entrenamientos/${id}`,
        {
          method: "PUT",
          headers: { "Content-Type": "application/json" },
          body: JSON.stringify({ fecha, hora }),
  ...
  const registrarEstudiante = async (entrenamientoId) => {
    try {
      ...
      const response = await fetch(
        `${import.meta.env.VITE_REACT_APP_API_URL}/asistencias`,
        {
          method: "POST",
          headers: { "Content-Type": "application/json" },
  ...
  const buscarEntrenamientoPorFecha = async () => {
    try {
      const response = await fetch(
        `${
          import.meta.env.VITE_REACT_APP_API_URL
        }/entrenamientos/buscar/fecha/${fecha}`
      );
      if (response.ok) {
        const data = await response.json();
  ...
  const buscarEntrenamientoPorHora = async () => {
    try {
      const response = await fetch(
        `${
          import.meta.env.VITE_REACT_APP_API_URL
        }/entrenamientos/buscar/hora/${hora}`
      );
      if (response.ok) {
        const data = await response.json();
        setEntrenamientos(data);
