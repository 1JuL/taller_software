...
import { Home, Login, Root, RegForm, NotFound, Personas, Torneos, Entrenamiento, Pagos, Participacion } from './pages'
      ...
      <AuthProvider>
        <BrowserRouter>
          <Routes>
            ...
            <Route path={ROUTES.PARTICIPACION.path} element={<PrivateRoute><Participacion /></PrivateRoute>} />
